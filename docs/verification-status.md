...
- **Anything outside V1 scope** — backups/restores, environment variable management, insights, problems, and organization/user/group administration are not implemented, so there's nothing to verify there yet. See [Architecture](architecture#scope).
